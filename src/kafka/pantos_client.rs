...
impl PantosKafkaClient {
    ...
    pub async fn consume_desired_topic(&self) -> String {
    ...
    pub async fn publish_started_loading(&self, robot_uid: &str) {
        let message = ReportMessage::new(
            "STARTED_TRAVELING",
            0.0,
            robot_uid,
        );
    ...
    pub async fn publish_loading(&self, robot_uid: &str) {
        let message = ReportMessage::new(
            "ARRIVED_AT_POINT",
            0.0,
            robot_uid,
    ...
    pub async fn publish_started_picking(&self, robot_uid: &str) {
        let message = ReportMessage::new(
            "STARTED_PICKING",
            0.0,
            robot_uid,
    ...
    // Deprecated?
    //pub async fn publish_waiting_worker_to_pick(&self, robot_uid: &str) {}

    pub async fn publish_picking(&self, robot_uid: &str) {
        let message = ReportMessage::new(
            "PICKING",
            0.0,
            robot_uid,
    ...
    pub async fn publish_started_unloading(&self, robot_uid: &str) {
        let message = ReportMessage::new(
            "STARTED_UNLOADING",
            0.0,
            robot_uid,
    ...
    pub async fn publish_unloading(&self, robot_uid: &str) {
        let message = ReportMessage::new(
            "UNLOADING",
            0.0,
            robot_uid,
    ...
    pub async fn publish_arrived_at_emergency_position(&self, robot_uid: &str) {
    }

    pub async fn publish_arrived_at_recovered_position(&self, robot_uid: &str) {
    }
}
